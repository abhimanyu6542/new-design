...
function Banner() {
  return (
    <>
      <div className="md:mt-64 sm:mt-96 mt-[600px] sm:mb-0 -mb-96">
        <div className="relative m-10">
          ...
          <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
            <h1 className="text-4xl font-bold text-center w-auto text-slate-500">
              Enjoy the seamless process of POS
            </h1>
            <button className="mt-7 px-10 py-2 text-lg text-white font-semibold bg-[#1D2130] border-0 rounded-md">
              Book a demo
            </button>
          </div>
