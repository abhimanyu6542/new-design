  ...
  return (
    <>
      <div className="border-2 border-white priceSection h-[450px] mb-44 mt-10">
        ...
        <div className="md:h-64 mt-2 sm:mt-1 md:mt-10 md:mx-auto mb-10 mx-5 flex flex-col md:flex-row justify-center items-center shadow-2xl rounded-xl md:w-[800px]  w-auto bg-[#FFFFFF] md:flex md:justify-around">
