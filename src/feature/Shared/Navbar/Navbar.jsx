        ...
        <div>
          ...
          >
            <div className="flex items-center gap-4">
              <HiMenuAlt1
                className="text-3xl ml-10 sm:ml-7 xl:hidden cursor-pointer"
            ...
            <div className="flex">
              ...
              {toggle && (
                ...
                >
                  ...
                  <div className="-mt-64">
                  <p className=" font-extrabold text-3xl leading-7 ml-7 ">Zinqler</p>
                    {navLinks.map((navLink) => {
                      return <MobileNavLinks key={navLink.id} {...navLink} setToggle={setToggle} />;
                    })}
                  </div>

                  <div className="mx-2 ml-7 sm:mx-4 text-base block sm:hidden">
                    <button className="bg-black text-white px-8 py-3 text-lg font-roboto rounded-xl">
                      Book Now
                    </button>
                  </div>
